...
class Ui_Pokerbot(object):
    def setupUi(self, Pokerbot):
        ...
        self.gridLayout.addLayout(self.gridLayout_2, 6, 3, 1, 3)
        ...
        self.gridLayout.addLayout(self.vLayout2, 9, 3, 1, 3)
        ...
        self.gridLayout.addLayout(self.vLayout3, 10, 0, 1, 3)
        ...
        self.gridLayout.addLayout(self.vLayout4, 10, 3, 1, 3)
        ...
        self.gridLayout.addLayout(self.verticalLayout_7, 6, 0, 1, 3)
        self.vLayout = QtWidgets.QVBoxLayout()
        self.vLayout.setObjectName("vLayout")
        self.widget_3 = QtWidgets.QWidget(self.centralwidget)
        self.widget_3.setObjectName("widget_3")
        self.vLayout.addWidget(self.widget_3)
        self.gridLayout.addLayout(self.vLayout, 9, 0, 1, 3)
        ...
        self.gridLayout.addLayout(self.verticalLayout_5, 4, 3, 1, 2)
        ...
        self.open_chat = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.right = QtWidgets.QVBoxLayout(self.verticalWidget)
        self.right.setObjectName("right")
        self.tablecard_2 = QtWidgets.QLabel(self.verticalWidget)
        self.tablecard_2.setObjectName("tablecard_2")
        self.right.addWidget(self.tablecard_2)
        self.mycard_2 = QtWidgets.QLabel(self.verticalWidget)
        self.mycard_2.setObjectName("mycard_2")
        self.right.addWidget(self.mycard_2)
        self.equity_2 = QtWidgets.QLabel(self.verticalWidget)
        self.equity_2.setObjectName("equity_2")
        self.right.addWidget(self.equity_2)
        self.gridLayout.addWidget(self.verticalWidget, 1, 3, 1, 3)
        self.verticalWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.verticalWidget_2.setObjectName("verticalWidget_2")
        self.left = QtWidgets.QVBoxLayout(self.verticalWidget_2)
        self.left.setObjectName("left")
        self.tablecard_1 = QtWidgets.QLabel(self.verticalWidget_2)
        self.tablecard_1.setObjectName("tablecard_1")
        self.left.addWidget(self.tablecard_1)
        self.mycard_1 = QtWidgets.QLabel(self.verticalWidget_2)
        self.mycard_1.setObjectName("mycard_1")
        self.left.addWidget(self.mycard_1)
        self.equity_3 = QtWidgets.QLabel(self.verticalWidget_2)
        self.equity_3.setObjectName("equity_3")
        self.left.addWidget(self.equity_3)
        self.gridLayout.addWidget(self.verticalWidget_2, 1, 0, 1, 3)
    ...
    def retranslateUi(self, Pokerbot):
        ...
        self.tablecard_2.setText(_translate("Pokerbot", "Table Card 2 :"))
        self.mycard_2.setText(_translate("Pokerbot", "My Card 2 :"))
        self.equity_2.setText(_translate("Pokerbot", "Equity:"))
        self.tablecard_1.setText(_translate("Pokerbot", "Table Card 1 :"))
        self.mycard_1.setText(_translate("Pokerbot", "My Card 1 :"))
        self.equity_3.setText(_translate("Pokerbot", "Equity:"))
